...
<div class="w-3/5 m-auto">
    <div class="grid grid-cols-6 grid-rows-11 gap-6">
        ...
        <div class="col-start-1 col-end-5 row-start-2 row-span-5 h-96 border-4" style="background-image:url(/img/imagen-prueba.png); background-size: 70%; background-position:center;background-repeat: no-repeat;"></div>
        ...
        <div class="text-xl col-start-5 col-span-2 row-start-2 h-52 border-4" style="background-image:url(/img/imagen-prueba.png); background-size: 70%; background-position:center;background-repeat: no-repeat;"></div>
        ...
        <div class="col-start-1 col-span-2 row-start-9 w-full h-52 border-4" style="background-image:url(/img/imagen-prueba.png); background-size: 100%; background-position:center;background-repeat: no-repeat;"></div>
        <div class="col-start-3 col-span-2 row-start-9 w-full h-52 border-4" style="background-image:url(/img/imagen-prueba.png); background-size: 100%; background-position:center;background-repeat: no-repeat;"></div>
        <div class="col-start-5 col-span-2 row-start-9 w-full h-52 border-4" style="background-image:url(/img/imagen-prueba.png); background-size: 100%; background-position:center;background-repeat: no-repeat;"></div>
