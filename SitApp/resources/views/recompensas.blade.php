...
<div class="w-4/5 m-auto py-10">
    ...
    <!--CONTENIDO DE INFORMACIÓN-->
        <div class="grid grid-cols-8 grid-rows-3 gap-4 mt-10 pb-32">
            ...
            <div class="col-start-1 col-span-3 row-start-4 mx-auto drop-shadow-xl">
                <div class="col-span-2">
                    <div class="grid grid-cols-3 gap-3 max-w-sm bg-[#F6F6F6] border-white rounded-3xl hover:bg-blue-100 transition-all duration-200 mx-10 mr-10">
            ...
            <div class="col-start-1 col-span-3 row-start-5 mx-auto drop-shadow-xl">
                <div class="col-span-2">
                    <div class="grid grid-cols-3 gap-3 max-w-sm bg-[#F6F6F6] border-white rounded-3xl hover:bg-blue-100 transition-all duration-200 mx-10 mr-10">
            ...
            <div class="col-start-6 col-span-3 row-start-4 mx-auto drop-shadow-xl">
                <div class="grid grid-cols-3 gap-3 max-w-sm bg-[#F6F6F6] border-white rounded-3xl hover:bg-blue-100 transition-all duration-200 mx-10 mr-10">
            ...
            <div class="col-start-6 col-span-3 row-start-5 mx-auto drop-shadow-xl">
                <div class="grid grid-cols-3 gap-3 max-w-sm bg-[#F6F6F6] border-white rounded-3xl hover:bg-blue-100 transition-all duration-200 mx-10 mr-10">
            ...
            <div class="col-start-3 col-span-4 row-start-6 mx-auto drop-shadow-xl">
                <div class="grid grid-cols-3 gap-3 max-w-sm bg-[#F6F6F6] border-white rounded-3xl hover:bg-blue-100 transition-all duration-200 mx-10 mr-10">
