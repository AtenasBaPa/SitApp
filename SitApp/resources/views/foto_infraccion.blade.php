...
<div class="h-auto w-3/4 m-auto">
    ...
    <!--Foto de la infraccion-->
    <div class="w-3/5 h-96 border-4 m-auto text-center">foto-multa</div>

    <div class="h-20"></div>
    <!--Descripción de la infraccion-->
    <div class="w-3/4 m-auto divide-y-2">
        <div class="text-center text-3xl pb-4">
            Descripción
        </div>
        <div class="text-justify pt-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nemo aut
            commodi tempore nisi eius sunt vero doloribus quae asperiores sed, delectus cumque non dignissimos
            veniam fuga accusantium facere voluptas necessitatibus!
        </div>
    </div>
