...
<body>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="px-12 py-12 text-center bg-blue-300 border-8 border-white rounded-3xl hover:bg-blue-100 transition-all duration-200"><img class="w-20" src="/sources/img/verificacion.png" /> Verificación</td>
