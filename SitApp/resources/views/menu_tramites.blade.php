...
@section('content')
    <div class="grid grid-cols-4 grid-rows-4 gap-6 w-6/12 m-auto alto-cont overflow-hidden">
            <div class="col-start-1 row-start-1 bg-blue-300 mx-auto rounded-3xl w-52 h-52 hover:bg-blue-100 transition-all duration-200 border-2" style="display:flex">
            ...
            <div class="col-start-2 row-start-1 bg-blue-300 mx-auto rounded-3xl w-52 h-52 hover:bg-blue-100 transition-all duration-200" style="display:flex">
            ...
            <div class="col-start-3 row-start-1 bg-blue-300 mx-auto rounded-3xl w-52 h-52 hover:bg-blue-100 transition-all duration-200" style="display:flex">
            ...
            <div class="col-start-4 row-start-1 bg-blue-300 mx-auto rounded-3xl w-52 h-52 hover:bg-blue-100 transition-all duration-200" style="display:flex">
            ...
            <div class="col-start-1 row-start-3 bg-blue-300 mx-auto rounded-3xl w-52 h-52 -mt-5 hover:bg-blue-100 transition-all duration-200" style="display:flex">
            ...
            <div class="col-start-2 row-start-3 bg-blue-300 mx-auto rounded-3xl w-52 h-52 -mt-5 hover:bg-blue-100 transition-all duration-200" style="display:flex">
            ...
            <div class="col-start-3 row-start-3 bg-blue-300 mx-auto rounded-3xl w-52 h-52 -mt-5 hover:bg-blue-100 transition-all duration-200" style="display:flex">
            ...
            <div class="col-start-4 row-start-3 bg-blue-300 mx-auto rounded-3xl w-52 h-52 -mt-5 hover:bg-blue-100 transition-all duration-200" style="display:flex">
