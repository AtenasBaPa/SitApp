    ...
    <div class="">
        <div class="text-lg">
            ...
            <div>
                ...
                <p class="text-4xl font-semibold text-center py-10">Recompensas</p>
            </div>
        </div>

        <div class="grid grid-cols-2 grid-rows-2 gap-9 justify-items-center">
            <div class="col-start-1 row-start-1 h-52 w-96 rounded-3xl bg-[#F6F6F6] drop-shadow-xl">
                <div class="w-full pl-8 m-8 text-5xl text-[#EB455F]">25% off</div>
            ...
            <div class="col-start-2 row-start-1 h-52 w-96 rounded-3xl bg-[#F6F6F6] drop-shadow-xl">
                <div class="w-full pl-8 m-8 text-5xl text-[#EB455F]">50% off</div>
            ...
            <div class="col-start-1 row-start-2 h-52 w-96 rounded-3xl bg-[#F6F6F6] drop-shadow-xl">
                <div class="w-full pl-8 m-8 text-5xl text-[#EB455F]">30% off</div>
            ...
            <div class="col-start-2 row-start-2 h-52 w-96 rounded-3xl bg-[#F6F6F6] drop-shadow-xl">
                <div class="w-full pl-8 m-8 text-5xl text-[#EB455F]">40% off</div>
            ...
            <div class="col-start-1 row-start-3 h-52 w-96 rounded-3xl bg-[#F6F6F6] drop-shadow-xl">
                <div class="w-full pl-8 m-8 text-5xl text-[#EB455F]">2 x 1</div>
            ...
            <div class="col-start-2 row-start-3 h-52 w-96 rounded-3xl bg-[#F6F6F6] drop-shadow-xl">
                <div class="w-full pl-8 m-8 text-5xl text-[#EB455F]">20% off</div>
