    ...
    <div class="w-3/4 m-auto">
        <div class="grid grid-cols-6 grid-rows-6 gap-7 mb-20">
            <div class="col-start-2 col-span-4 row-start-1 rounded-lg bg-[#437ECB] flex items-center drop-shadow-2xl justify-center h-20">
                <p class="text-white text-4xl mx-auto">Bienvenido <?php echo e(auth()->user()->nombre); ?></p>
            </div>
                ...
                <div id="seccion_cuenta" class="block">
                    <div class="grid grid-cols-4 grid-rows-6">
                        ...
                        <div class="col-start-2 row-start-3 w-48">
                            <p class="text-xl"><?php echo e(auth()->user()->nombre); ?></p>
                        </div>

                        <div class="col-start-2 row-start-4 w-48">
                            <p class="text-xl"><?php echo e(auth()->user()->licencia); ?></p>
                        </div>
                        ...
                        <div class="col-start-4 row-start-3 w-48 -ml-16">
                            <p class="text-xl"><?php echo e(auth()->user()->correo); ?></p>
                        </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SitApp1\resources\views/cuenta.blade.php ENDPATH**/ ?>